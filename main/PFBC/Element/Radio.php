...
JS;
	...
	public function render() { 
		...
		foreach($this->options as $value => $text) {
			...
			echo '<div class="pfbc-radio"><table summary="RadioButton" cellpadding="0" cellspacing="0"><tr><td valign="top"><input id="', $this->attributes["id"], "-", $count, '"', $this->getAttributes(array("id", "value", "checked")), ' value="', $this->filter($value), '"';
